...
```
```sh
2022-09-24 11:48:24.568 UTC 0001 INFO [cli.lifecycle.chaincode] submitInstallProposal -> Installed remotely: response:<status:200 payload:"\nIfedfab_4:5a2deba28f8e6b55630f6356e7edba393873add6bc246d72f8f31ab053baaa5e\022\010fedfab_3" > 
2022-09-24 11:48:24.568 UTC 0002 INFO [cli.lifecycle.chaincode] submitInstallProposal -> Chaincode code package identifier: fedfab_4:5a2deba28f8e6b55630f6356e7edba393873add6bc246d72f8f31ab053baaa5e
```

# 组织org批准链码
```sh
peer lifecycle chaincode approveformyorg --channelID channel2 --name fedfab --version 1.0 --package-id fedfab_4:5a2deba28f8e6b55630f6356e7edba393873add6bc246d72f8f31ab053baaa5e  --sequence 4 --init-required --tls true --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/fedfab.com/orderers/orderer.fedfab.com/msp/tlscacerts/tlsca.fedfab.com-cert.pem 
```
...
# 提交
```sh
peer lifecycle chaincode commit -o orderer.fedfab.com:7050 --channelID channel2 --name fedfab --version 1.0 --sequence 4 --tls true  --init-required --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/fedfab.com/orderers/orderer.fedfab.com/msp/tlscacerts/tlsca.fedfab.com-cert.pem \
